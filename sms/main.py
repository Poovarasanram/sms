...
class Management:
    ...
    def AddStudent(self):
        ...
        self.name = Label(self.frame_2, text="First Name", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=100, y=20)
        self.name_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.name_entry.place(x=100, y=50, width=200)

        self.surname = Label(self.frame_2, text="Last Name", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=530, y=20)
        self.surname_entry = Entry(
            self.frame_2, bg=self.color_4, fg=self.color_3)
        self.surname_entry.place(x=530, y=50, width=200)

        self.course = Label(self.frame_2, text="Course", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=100, y=80)
        self.course_entry = Entry(
            self.frame_2, bg=self.color_4, fg=self.color_3)
        self.course_entry.place(x=100, y=110, width=200)

        self.Course_Package = Label(self.frame_2, text="Course Package", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=530, y=80)
        self.Course_Package_entry = Entry(
            self.frame_2, bg=self.color_4, fg=self.color_3)
        self.Course_Package_entry.place(x=530, y=110, width=200)

        self.date = Label(self.frame_2, text="Date", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=100, y=140)
        self.date_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.date_entry.place(x=100, y=170, width=200)

        self.age = Label(self.frame_2, text="Age", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=530, y=140)
        self.age_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.age_entry.place(x=530, y=170, width=200)

        self.gender = Label(self.frame_2, text="Gender", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=100, y=200)
        self.gender_entry = Entry(
            self.frame_2, bg=self.color_4, fg=self.color_3)
        self.gender_entry.place(x=100, y=230, width=200)

        self.birth = Label(self.frame_2, text="Birthday", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=530, y=200)
        self.birth_entry = Entry(
            self.frame_2, bg=self.color_4, fg=self.color_3)
        self.birth_entry.place(x=530, y=230, width=200)

        self.contact = Label(self.frame_2, text="Contact No", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=100, y=260)
        self.contact_entry = Entry(
            self.frame_2, bg=self.color_4, fg=self.color_3)
        self.contact_entry.place(x=100, y=290, width=200)

        self.email = Label(self.frame_2, text="Email", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=530, y=260)
        self.email_entry = Entry(
            self.frame_2, bg=self.color_4, fg=self.color_3)
        self.email_entry.place(x=530, y=290, width=200)

        self.Current_Course = Label(self.frame_2, text="Current Course", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=100, y=320)
        self.Current_Course_entry = Entry(
            self.frame_2, bg=self.color_4, fg=self.color_3)
        self.Current_Course_entry.place(x=100, y=350, width=200)

        self.Pending_Course = Label(self.frame_2, text="Pending Course", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=530, y=320)
        self.Pending_Course_entry = Entry(
            self.frame_2, bg=self.color_4, fg=self.color_3)
        self.Pending_Course_entry.place(x=530, y=350, width=200)

        self.Completed_Course = Label(self.frame_2, text="Completed Course", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=100, y=380)
        self.Completed_Course_entry = Entry(
            self.frame_2, bg=self.color_4, fg=self.color_3)
        self.Completed_Course_entry.place(x=100, y=410, width=200)

        self.Total_Fees = Label(self.frame_2, text="Total Fees", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=530, y=380)
        self.Total_Fees_entry = Entry(
            self.frame_2, bg=self.color_4, fg=self.color_3)
        self.Total_Fees_entry.place(x=530, y=410, width=200)

        self.Paid_Fees = Label(self.frame_2, text="Paid Fees", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=100, y=440)
        self.Paid_Fees_entry = Entry(
            self.frame_2, bg=self.color_4, fg=self.color_3)
        self.Paid_Fees_entry.place(x=100, y=470, width=200)

        self.Balance_Fees = Label(self.frame_2, text="Balance Fees", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=530, y=440)
        self.Balance_Fees_entry = Entry(
            self.frame_2, bg=self.color_4, fg=self.color_3)
    ...
    def GetContact_View(self):
        ...
        self.getInfo = Label(self.frame_2, text="Enter Contact Number", font=(
            self.font_2, 18, "bold"), bg=self.color_2).place(x=332, y=170)
        self.getInfo_entry = Entry(self.frame_2, font=(
            self.font_1, 12), bg=self.color_4, fg=self.color_3)
    ...
    def date(self):
        ...
        self.getInfo = Label(self.frame_2, text="Enter Date", font=(
            self.font_2, 18, "bold"), bg=self.color_2).place(x=400, y=170)
        self.getInfo_entry = Entry(self.frame_2, font=(
            self.font_1, 12), bg=self.color_4, fg=self.color_3)
    ...
    def CheckContact_View(self):
        if self.getInfo_entry.get() == "":
            messagebox.showerror(
                "Error!", "Please enter your contact number", parent=self.window)
        else:
            try:
                ...
                curs.execute(
                    "select * from fk where contact=%s", self.getInfo_entry.get())
                row = curs.fetchone()
                if row == None:
                    messagebox.showerror(
                        "Error!", "Contact number doesn't exists", parent=self.window)
                else:
                    self.ShowDetails(row)
                    connection.close()
            except Exception as e:
                messagebox.showerror(
                    "Error!", f"Error due to {str(e)}", parent=self.window)
    ...
    def Checkdate_View(self):
        if self.getInfo_entry.get() == "":
            ...
            try:
                ...
                curs = connection.cursor()
                curs.execute(
                    "select * from fk where date=%s", self.getInfo_entry.get())
                row = curs.fetchone()
        ...
        if self.getInfo_entry.get() == "":
            ...
            try:
                ...
                if row == None:
                    ...
                    curs.execute(
                        "delete from fk where contact=%s", self.getInfo_entry.get())
                    connection.commit()
    ...
    def GetUpdateDetails(self, row):
        ...
        contact = Label(self.frame_2, text="Contact", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=100, y=260)
        contact_data = Label(self.frame_2, text=row[8], font=(
            self.font_1, 10)).place(x=100, y=290)
    ...
    def ShowDetails(self, row):
        self.ClearScreen()
        name = Label(self.frame_2, text="First Name", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=100, y=20)
        name_data = Label(self.frame_2, text=row[0], font=(
            self.font_1, 10)).place(x=100, y=50)

        surname = Label(self.frame_2, text="Last Name", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=530, y=20)
        surname_data = Label(self.frame_2, text=row[1], font=(
            self.font_1, 10)).place(x=530, y=50)

        course = Label(self.frame_2, text="Course", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=100, y=80)
        course_data = Label(self.frame_2, text=row[2], font=(
            self.font_1, 10)).place(x=100, y=110)

        Course_Package = Label(self.frame_2, text="Course Package", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=530, y=80)
        Course_Package = Label(self.frame_2, text=row[3], font=(
            self.font_1, 10)).place(x=530, y=110)

        Date = Label(self.frame_2, text="Date", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=100, y=140)
        Date_data = Label(self.frame_2, text=row[4], font=(
            self.font_1, 10)).place(x=100, y=170)

        age = Label(self.frame_2, text="Age", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=530, y=140)
        age_data = Label(self.frame_2, text=row[5], font=(
            self.font_1, 10)).place(x=530, y=170)

        gender = Label(self.frame_2, text="Gender", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=100, y=200)
        gender_data = Label(self.frame_2, text=row[6], font=(
            self.font_1, 10)).place(x=100, y=230)

        birth = Label(self.frame_2, text="DOB", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=530, y=200)
        birth_data = Label(self.frame_2, text=row[7], font=(
            self.font_1, 10)).place(x=530, y=230)

        contact = Label(self.frame_2, text="Contact No", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=100, y=260)
        contact_data = Label(self.frame_2, text=row[8], font=(
            self.font_1, 10)).place(x=100, y=290)

        email = Label(self.frame_2, text="Email", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=530, y=260)
        email_data = Label(self.frame_2, text=row[9], font=(
            self.font_1, 10)).place(x=530, y=290)

        Current_Course = Label(self.frame_2, text="Current Course", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=100, y=320)
        Current_Course_data = Label(self.frame_2, text=row[10], font=(
            self.font_1, 10)).place(x=100, y=350)

        Pending_Course = Label(self.frame_2, text="Pending Course", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=530, y=320)
        Pending_Course_data = Label(self.frame_2, text=row[11], font=(
            self.font_1, 10)).place(x=530, y=350)

        Completed_Course = Label(self.frame_2, text="Completed Course", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=100, y=380)
        Completed_Course_data = Label(self.frame_2, text=row[12], font=(
            self.font_1, 10)).place(x=100, y=410)

        Total_Fees = Label(self.frame_2, text="Total Fees", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=530, y=380)
        Total_Fees_data = Label(self.frame_2, text=row[13], font=(
            self.font_1, 10)).place(x=530, y=410)

        Paid_Fees = Label(self.frame_2, text="Paid Fees", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=100, y=440)
        Paid_Fees_data = Label(self.frame_2, text=row[14], font=(
            self.font_1, 10)).place(x=100, y=470)

        Balance_Fees = Label(self.frame_2, text="Balance Fees", font=(
            self.font_2, 15, "bold"), bg=self.color_2).place(x=530, y=440)
        Balance_Fees_data = Label(self.frame_2, text=row[15], font=(
            self.font_1, 10)).place(x=530, y=470)
    ...
    def UpdateDetails(self, row):
        if (self.name_entry.get() == "" or self.surname_entry.get() == "" or self.course_entry.get() == "" or self.Course_Package_entry.get() == "" or
            ...
            try:
                ...
                curs = connection.cursor()
                curs.execute(
                    "select * from fk where contact=%s", row[8])
                row = curs.fetchone()

                if row == None:
                    messagebox.showerror(
                        "Error!", "The contact number doesn't exists", parent=self.window)
                else:
                    curs.execute("update fk set f_name=%s,l_name=%s, course=%s, course_Package=%s, date=%s, age=%s, gender=%s, birth=%s,email=%s,current_course=%s,pending_course=%s,completed_course=%s,total_fees=%s,paid_fees=%s,balance_fees=%s where contact=%s",
                                 (
                                     self.name_entry.get(),
    ...
    def Submit(self):
        if (self.name_entry.get() == "" or self.surname_entry.get() == "" or self.course_entry.get() == "" or self.Course_Package_entry.get() == "" or
            self.date_entry.get() == "" or self.age_entry.get() == "" or self.gender_entry.get(
        ) == "" or self.birth_entry.get() == "" or self.contact_entry.get() == ""
            ...
            try:
                ...
                curs = connection.cursor()
                curs.execute(
                    "select * from fk where contact=%s", self.contact_entry.get())
                row = curs.fetchone()

                if row != None:
                    messagebox.showerror(
                        "Error!", "The contact number is already exists, please try again with another number", parent=self.window)
                else:
                    curs.execute("insert into fk (f_name,l_name,course,course_package,date,age,gender,birth,contact,email,current_course,pending_course,completed_course,Total_fees,paid_fees,balance_fees)values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",
                                 (
                                     self.name_entry.get(),
                                     self.surname_entry.get(),
                                     self.course_entry.get(),
